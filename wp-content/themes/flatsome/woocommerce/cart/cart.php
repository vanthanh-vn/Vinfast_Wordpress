...
<section class="vf-cart-page">
	<div class="vf-cart-heading">
		<h1>Giỏ Hàng Của Bạn</h1>
		<p>Bạn có <?php echo esc_html( WC()->cart->get_cart_contents_count() ); ?> sản phẩm trong giỏ hàng</p>
	</div>

	<a class="vf-continue-shopping" href="<?php echo esc_url( wc_get_page_permalink( 'shop' ) ); ?>">← Tiếp tục mua sắm</a>
...
<div class="cart-collaterals large-12 col pb-0">
	...
	<div class="cart-sidebar col-inner <?php echo esc_attr( $sidebar_classes ); ?>">
		<h3 class="vf-order-summary-title"><?php echo get_flatsome_icon( 'icon-menu' ); ?> Tóm Tắt Đơn Hàng</h3>
		...
		<form class="checkout_coupon mb-0" method="post">
			<div class="coupon">
				...
				<button type="submit" class="is-form button<?php if ( fl_woocommerce_version_check( '7.0.1' ) ) { echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); } ?>" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>">Áp dụng</button>
